...
import 'package:mustafachatclone/features/call/pages/pick_up_call_page.dart';
...
import '../../call/controllers/call/call_history_page_controller.dart';
...
class SingleChat extends StatelessWidget {
  ...
  //  child: StreamBuilder<List<MessageModel>>(stream: controller.getMessages(), builder: (context,AsyncSnapshot<List<MessageModel>>snapShot){
    ...
    return PickUpCallPage(
      uid:  currentConversation.senderUid,
        child: Scaffold(
          appBar: AppBar(
            ...
            actions: [
              ...
              GestureDetector(
                onTap: () {
                  callController.makeCallButton(
                      CallModel(
                        callerId: currentConversation.senderUid,
                        callerName: currentConversation.senderName,
                        callerProfileUrl: currentConversation.senderProfile,
                        receiverId: currentConversation.recipientUid,
                        receiverName: currentConversation.recipientName,
                        receiverProfileUrl: currentConversation.recipientProfile,
                      )
                  );
